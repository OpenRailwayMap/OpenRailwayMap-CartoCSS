...
#railway_bridge::casing[zoom>=9] {
  ...
  [zoom>=13]["railway"="construction"]["construction_railway"="subway"]["service"!=null],
  [zoom>=13]["railway"="proposed"]["proposed_railway"="subway"]["service"!=null],
  [zoom>=13]["railway"="construction"]["construction_railway"="light_rail"]["service"!=null],
  [zoom>=13]["railway"="proposed"]["proposed_railway"="light_rail"]["service"!=null],
  [zoom>=13]["railway"="construction"]["construction_railway"="tram"]["service"!=null],
  [zoom>=13]["railway"="proposed"]["proposed_railway"="tram"]["service"!=null],
