...
const poiUncolored = poi.features
  .flatMap(feature => [feature, ...(feature.variants || []).map(it => ({...it, minzoom: feature.minzoom}))])
  .filter(feature => !feature.colored_icon);
...
const layers = Object.fromEntries(knownThemes.map(theme => [theme, {
  standard: [
    {
      ...
      paint: {
        'fill-color': ['case',
          ...
          ['==', ['get', 'feature'], 'tram_stop'], colors[theme].styles.standard.tram,
    ...
    },
    {
      ...
      paint: {
        'text-color': ['case',
          ...
          ['==', ['get', 'feature'], 'tram_stop'], colors[theme].styles.standard.tramStopText,
          ['any',
            ['==', ['get', 'feature'], 'station'],
            ['==', ['get', 'feature'], 'halt'],
          ], ['case',
  ...
  electrification: [
    ...
    ),
    {
      ...
      paint: {
        'circle-radius': ['interpolate', ['exponential', 1.2], ['zoom'],
          14, 2,
          15, 3,
        ],
        'circle-color': 'blue',
